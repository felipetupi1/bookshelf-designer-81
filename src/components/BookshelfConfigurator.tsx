...
const FINISH_OPTIONS = [
  {
    id: "White/White", label: "White/White", price: 41.6,
  ...
  },
  {
    ...
    color1: "#1a1a1a", color2: "#1a1a1a", comingSoon: false, previewImage: null as string | null,
  },
  {
    id: "Oak/White", label: "Oak/White", price: 60.18,
    color1: "#D4A574", color2: "#f5f5f5", comingSoon: true, previewImage: null as string | null,
  },
  {
  ...
  {
    id: "Oak/Oak", label: "Oak/Oak", price: 68.15,
    color1: "#D4A574", color2: "#D4A574", comingSoon: false, previewImage: "/images/finishes/oak.jpg",
  },
  {
    id: "Walnut/Walnut", label: "Walnut/Walnut", price: 76.2,
    ...
    <div className="w-full min-h-screen configurator-root">
      ...
      <header className="sticky top-0 z-30 bg-background/80 backdrop-blur-lg border-b border-border configurator-header">
        <div className="max-w-[1600px] mx-auto flex items-center justify-between px-4 md:px-8 h-14">
          ...
          <div className="flex items-center gap-3">
            <button onClick={handleReset} className="text-muted-foreground hover:text-foreground transition-colors" title="Reset">
            ...
            >
              ...
              <span className="hidden sm:inline">{isAddingToCart ? "Processing..." : "Add to Cart"}</span>
            </Button>
          </div>
        </div>
      </header>
